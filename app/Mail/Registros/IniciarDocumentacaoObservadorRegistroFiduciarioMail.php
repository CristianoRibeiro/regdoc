...
class IniciarDocumentacaoObservadorRegistroFiduciarioMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if (View::exists('email.produtos.registros.pessoas.'.$id_pessoa_origem.'.iniciar-documentacao-observador')) {
            $view = 'email.produtos.registros.pessoas.'.$id_pessoa_origem.'.iniciar-documentacao-observador';
        } else {
            $view = 'email.produtos.registros.iniciar-documentacao-observador';
        }
