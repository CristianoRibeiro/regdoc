...
@section('content')
    ...
    <p>
        A fase de documentação do contrato foi iniciada em nossa plataforma para assinatura do contrato, envio de documentações e etc.
    </p>
    <p>
        Você foi inserido como um observador no contrato e poderar acompanhar todo o processo.
    </p>
