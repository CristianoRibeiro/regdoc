...
class IniciarEnvioRegistroFiduciarioMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if (View::exists('email.produtos.registros.pessoas.'.$id_pessoa_origem.'.iniciar-envio')) {
            $view = 'email.produtos.registros.pessoas.'.$id_pessoa_origem.'.iniciar-envio';
        } else {
            $view = 'email.produtos.registros.iniciar-envio';
        }
