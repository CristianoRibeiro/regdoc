...
class registro_fiduciario_parte_assinatura extends Model
{
    ...
    {
        return $this->belongsTo(registro_fiduciario_procurador::class,'id_registro_fiduciario_procurador');
    }
    ...
    {
        return $this->hasMany(registro_fiduciario_parte_assinatura_arquivo::class,'id_registro_fiduciario_parte_assinatura');
    }

    public function arquivos_nao_assinados()
    {
        return $this->hasMany(registro_fiduciario_parte_assinatura_arquivo::class,'id_registro_fiduciario_parte_assinatura')->whereNull('id_arquivo_grupo_produto_assinatura');
    }
    public function arquivos_assinados()
    {
        return $this->hasMany(registro_fiduciario_parte_assinatura_arquivo::class,'id_registro_fiduciario_parte_assinatura')->whereNotNull('id_arquivo_grupo_produto_assinatura');
    }
