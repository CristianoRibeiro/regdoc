	...
	<table width="80%" align="center" bgcolor="#ffffff" cellspacing="0" cellpadding="0" style="text-align: justify; font-size: 15px;">
		<tr>
			<td>
			    ...
			    O registro eletrônico do contrato de Crédito Imobiliário Bradesco foi concluído!<br>

			    A matrícula registrada foi disponibilizada no sistema do Banco para liberação dos recursos ao vendedor.<br>

			    O gerente de relacionamento Bradesco poderá apoiá-lo nessa ultima etapa.
			    <br><br>
				...
				Para acessar a matrícula utilize umas das opções abaixo:<br /><br />
