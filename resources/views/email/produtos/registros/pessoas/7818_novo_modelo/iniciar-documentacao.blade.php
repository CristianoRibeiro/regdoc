	...
	<table width="100%" align="center" bgcolor="#ffffff" cellspacing="0" cellpadding="0" style="text-align: justify; font-size: 15px;">
		<tr>
			<td>
				...
				<p>
					O contrato número <strong>{{$registro_fiduciario->nu_contrato}}</strong> de <strong>{{$registro_fiduciario->registro_fiduciario_pedido->pedido->produto->no_produto ?? 'Registro'}}</strong> Bradesco está disponível para assinatura.
				</p>
				<p>
					<strong>Veja o status do processo: </strong>
				</p>
				<p>
					<img width="100%" src="{{asset('img/e-mails/7818/timeline-parte-3.png')}}">
				</p>
				...
				<hr size="1" />
				<h3 style="color: #CC092F">Como realizar a assinatura?</h3>
				<p>
