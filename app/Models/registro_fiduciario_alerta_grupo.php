...
class registro_fiduciario_alerta_grupo extends Model
{
    protected $table = 'registro_fiduciario_alerta_grupo';
    protected $primaryKey = 'id_registro_fiduciario_alerta_grupo';
    public $timestamps = false;

    // Funções de relacionamento
    public function registro_fiduciario_alerta()
    {
        return $this->hasMany(registro_fiduciario_alerta::class,'id_registro_fiduciario_alerta_grupo');
    }

    // Funções especiais
    public function total() {
    	$total = $this->hasMany(registro_fiduciario_alerta::class,'id_registro_fiduciario_alerta_grupo')
    				  ->join('registro_fiduciario_alerta_regra', 'registro_fiduciario_alerta_regra.id_registro_fiduciario_alerta', '=', 'registro_fiduciario_alerta.id_registro_fiduciario_alerta')
