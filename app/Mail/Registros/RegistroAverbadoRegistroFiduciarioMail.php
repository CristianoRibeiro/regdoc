...
class RegistroAverbadoRegistroFiduciarioMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if (View::exists('email.produtos.registros.pessoas.'.$id_pessoa_origem.'.registro-averbado')) {
            $view = 'email.produtos.registros.pessoas.'.$id_pessoa_origem.'.registro-averbado';
        } else {
            $view = 'email.produtos.registros.registro-averbado';
        }
