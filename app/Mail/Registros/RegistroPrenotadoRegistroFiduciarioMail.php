...
class RegistroPrenotadoRegistroFiduciarioMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if (View::exists('email.produtos.registros.pessoas.'.$id_pessoa_origem.'.registro-prenotado')) {
            $view = 'email.produtos.registros.pessoas.'.$id_pessoa_origem.'.registro-prenotado';
        } else {
            $view = 'email.produtos.registros.registro-prenotado';
        }
