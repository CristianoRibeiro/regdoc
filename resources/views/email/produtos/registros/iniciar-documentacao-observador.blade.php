...
@section('content')
    ...
    A fase de documentação do contrato foi iniciada em nossa plataforma para assinatura do contrato, envio de documentações e etc.<br /><br />

    Você foi inserido como um observador no contrato e poderar acompanhar todo o processo.<br /><br />
