...
class IniciarDocumentacaoRegistroFiduciarioMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if (View::exists('email.produtos.registros.pessoas.'.$id_pessoa_origem.'.iniciar-documentacao')) {
            $view = 'email.produtos.registros.pessoas.'.$id_pessoa_origem.'.iniciar-documentacao';
        } else {
            $view = 'email.produtos.registros.iniciar-documentacao';
        }
