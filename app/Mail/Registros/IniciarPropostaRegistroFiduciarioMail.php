...
class IniciarPropostaRegistroFiduciarioMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if (View::exists('email.produtos.registros.pessoas.'.$id_pessoa_origem.'.iniciar-proposta')) {
            $view = 'email.produtos.registros.pessoas.'.$id_pessoa_origem.'.iniciar-proposta';
        } else {
            $view = 'email.produtos.registros.iniciar-proposta';
        }
