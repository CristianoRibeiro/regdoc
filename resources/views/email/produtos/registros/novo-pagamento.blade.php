...
@section('content')
	...
	Um novo pagamento de {{$registro_fiduciario_pagamento->registro_fiduciario_pagamento_tipo->no_registro_fiduciario_pagamento_tipo}} foi inserido no registro nº {{$registro_fiduciario->registro_fiduciario_pedido->pedido->protocolo_pedido}}<br /><br />
