...
class LacunaPades
{
    ...
    public static function getVisualRepresentationPosition($sampleNumber)
    {
        ...
        switch ($sampleNumber) {
            ...
            case 1:
                ...
                return PadesVisualPositioningPresets::getFootnote($RestPki);

            case 2:
                // Example #2: get the footnote positioning preset and customize it
                $visualPosition = PadesVisualPositioningPresets::getFootnote($RestPki);
            ...
            case 3:
                ...
                return PadesVisualPositioningPresets::getNewPage($RestPki);

            case 4:
                // Example #4: get the "new page" positioning preset and customize it
                $visualPosition = PadesVisualPositioningPresets::getNewPage($RestPki);
                $visualPosition->auto->container->left = 2.54;
            ...
            case 7:
                // Example #4: get the "new page" positioning preset and customize it
                $visualPosition = PadesVisualPositioningPresets::getFootnote($RestPki);
                $visualPosition->auto->container->left = 0.5;
                $visualPosition->auto->container->bottom = 0.5;
                $visualPosition->auto->signatureRectangleSize->width = 3;
                $visualPosition->auto->signatureRectangleSize->height = 2;
                return $visualPosition;
            default:
                return null;
        }
