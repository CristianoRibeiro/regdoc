...
class ConfirmacaoAgendamentoEmissaoCertificadoRegistroFiduciarioMail extends Mailable
{
    ...
    {
        $id_pessoa = 76450;
        $view = "email.produtos.registros.pessoas.{$id_pessoa}.confirmacao-agendamento-emissao-certificado";
