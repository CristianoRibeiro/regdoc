		...
		<tr>
			<td style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 14px; font-weight: regular; line-height: 21px; color: #423a3d;">
				...
				<p style="margin-top: 30px; margin-bottom: 0;">
					As custas e emolumentos estão disponíveis.
				</p>
				<p style="margin-top: 10px; margin-bottom: 0;">
					Você deve pagar o boleto disponível na plataforma.
				</p>
				...
				<h1 style="margin-top: 35px; margin-bottom: 0; color: #f5822a; font-size: 23px; font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; line-height: 34.5px;">
					Após o pagamento:
				</h1>

				<p style="margin-top: 30px; margin-bottom: 0;">
					Você deve acessar a plataforma e anexar o comprovante.
				</p>
				<a href="{{URL::to('/protocolo/acessar/'.$args_email['token'])}}" style="display: block; margin-top: 35px; margin-bottom: 0; color:#f6881f; font-size: 21px; font-weight: bold; text-decoration:none; text-align:center">
					[ ANEXAR ]
				</a>
