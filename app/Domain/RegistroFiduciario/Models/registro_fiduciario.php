...
class registro_fiduciario extends Model
{
    ...
    public function registro_fiduciario_canal_pdv_parceiro()
    {
        return $this->hasOne(registro_fiduciario_canal_pdv_parceiro::class, 'id_registro_fiduciario');
    }
    ...
    public function registro_fiduciario_comentarios_internos()
    {
        return $this->hasMany('App\Domain\RegistroFiduciario\Models\registro_fiduciario_comentario_interno', 'id_registro_fiduciario')->orderBy('dt_cadastro','DESC');
    }
    ...
    {
        return $this->hasMany('App\Domain\RegistroFiduciario\Models\registro_fiduciario_operador', 'id_registro_fiduciario')->where('in_registro_ativo', 'S')->orderBy('dt_cadastro','DESC');
    }
    ...
    public function registro_fiduciario_reembolsos()
    {
        return $this->hasMany('App\Domain\RegistroFiduciario\Models\registro_fiduciario_reembolso', 'id_registro_fiduciario')->orderBy('dt_cadastro','DESC');
    }
}
