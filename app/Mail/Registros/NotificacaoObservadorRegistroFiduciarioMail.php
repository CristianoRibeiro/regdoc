...
class NotificacaoObservadorRegistroFiduciarioMail extends Mailable
{
    use Queueable, SerializesModels;

    public $registro_fiduciario;
    public $registro_fiduciario_observador;
    public $mensagem;
    public $mensagemBradesco;
    public $assunto;
    ...
    public function __construct(registro_fiduciario $registro_fiduciario,
                                registro_fiduciario_observador $registro_fiduciario_observador,
                                string $mensagem,
                                string $mensagemBradesco,
                                string $assunto)
    {
        $this->registro_fiduciario = $registro_fiduciario;
        $this->registro_fiduciario_observador = $registro_fiduciario_observador;
        $this->mensagem = $mensagem;
        $this->mensagemBradesco = $mensagemBradesco;
    ...
    public function build()
    {
        ...
        if (View::exists('email.produtos.registros.pessoas.'.$id_pessoa_origem.'.notificacao-observador')) {
            $view = 'email.produtos.registros.pessoas.'.$id_pessoa_origem.'.notificacao-observador';
        } else {
            $view = 'email.produtos.registros.notificacao-observador';
        }
