...
class DocumentacaoRegistroProcessoAssinaturaRegistroFiduciarioMail extends Mailable
{
    ...
    {
        $id_pessoa = 76450;
        $view = "email.produtos.registros.pessoas.{$id_pessoa}.documentacao-registro-processo-assinaturas";
