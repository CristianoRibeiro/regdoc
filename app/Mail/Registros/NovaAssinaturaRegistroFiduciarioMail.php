...
class NovaAssinaturaRegistroFiduciarioMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if (View::exists('email.produtos.registros.pessoas.'.$id_pessoa_origem.'.nova-assinatura')) {
            $view = 'email.produtos.registros.pessoas.'.$id_pessoa_origem.'.nova-assinatura';
        } else {
            $view = 'email.produtos.registros.nova-assinatura';
        }
