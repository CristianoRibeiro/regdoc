...
@section('content')
    ...
    O seu registro foi prenotado no cartório com o número {{$args_email['numero_prenotacao'] ?? '##'}}. Isso significa que o cartório aceitou iniciar o registro e em breve retornaremos com mais novidades sobre seu registro.<br /><br />
